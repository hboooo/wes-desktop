...
namespace Wes.Customer.Sinbon.ViewModel
{
    public class SowViewModel : ScanViewModelBase<WesFlowID, SowAction>, IViewModel
    {
        ...
        protected override void InitNextTargets(Dictionary<WesFlowID, dynamic> nextTargets)
        {
            ...
            nextTargets.Add(WesFlowID.FLOW_ACTION_SCAN_PID_OR_PN_OR_CLCODE_OR_QRCODE, new { tooltip = "PID Or PN Or CLCode Or QrCode" });
            nextTargets.Add(WesFlowID.FLOW_ACTION_SCAN_DC_NO, new { tooltip = "DateCode" });
            nextTargets.Add(WesFlowID.FLOW_ACTION_SCAN_LOT_NO, new { tooltip = "LotNo" });
